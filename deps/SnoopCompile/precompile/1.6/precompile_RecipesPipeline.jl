...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(_series_data_vector),StepRangeLen{Float64, Base.TwicePrecision{Float64}, Base.TwicePrecision{Float64}},Dict{Symbol, Any}})
    ...
    Base.precompile(Tuple{typeof(setindex!),DefaultsDict,Bool,Symbol})
